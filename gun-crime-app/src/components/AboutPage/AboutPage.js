    ...
    return (
        <div className="container is-fluid">
            <div className="notification">
                ...
                <p>The data represented on this map is a visualisation of every shooting occurence documented by the NYPD throughout 2018. According to NYC Open Data, the data is freely available for "the public to explore the nature of police enforcement activity."</p>               
